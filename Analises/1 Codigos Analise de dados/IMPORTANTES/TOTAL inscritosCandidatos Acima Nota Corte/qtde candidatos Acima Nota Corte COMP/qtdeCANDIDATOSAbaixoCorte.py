...
for year in ano: 
    for semestre in sem:
        ...
        filtro= df_sort['Média nota Enem'] < df_sort['Nota Corte Grupo Preferência']

        df_sort=df_sort[filtro].copy()

        df_sort= df_sort.drop_duplicates(subset='ID do estudante',keep='first')
...
df_salvar
# %%
salvar_caminho= 'qtdeCANDIDATOSAbaixoCorte.csv'
