...
for year in ano: 
    for semestre in sem:
        ...
        #ins_df_sort=ins_df_sort.drop_duplicates(subset='ID do estudante',keep='first')
...
a= 'Analises/datasets/inscricoesDuplicatas.csv'
...
# %%
c.to_csv('situacaoINSCRITOSTotalTUDO.csv')


# %%
z=pd.read_csv('situacaoINSCRITOSTotalTUDO.csv',index_col='Unnamed: 0')
z
# %%
